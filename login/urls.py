...
urlpatterns = [
    ...
    path('accounts/async_password_reset_done/', auth_views.MyPasswordResetCompleteView.as_view(), name='login-async_reset_done'),
    # re_path('accounts/async_password_reset/(?P<uidb64>[0-9A-Za-z_\-]+)/', auth_views.MyPasswordResetConfirmView, name='login-async_reset_confirm_done'),
